...
COPY ./php_set_timezone.ini /etc/php82/conf.d/00_timezone.ini
COPY ./php_set_jit.ini /etc/php82/conf.d/00_jit.ini
COPY ./php_set_memory_limit.ini /etc/php82/conf.d/00_memlimit.ini
COPY ./php_h5ai_optimizations.ini /etc/php82/conf.d/01_h5ai_optimizations.ini
COPY ./h5ai.conf /etc/nginx/conf.d/h5ai.conf

RUN mkdir -p /usr/share/h5ai/_h5ai
COPY ./_h5ai /usr/share/h5ai/_h5ai
